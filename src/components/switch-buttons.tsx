    ...
    return (
        <div className="switch-buttons">
            ...
            <div className="switching-dates-container">
                <button className={`button button-prev-date ${isDisabledPrev ? 'disabled-button' : ''}`} onClick={handlePrev} disabled={isDisabledPrev}></button>
                <button className={`button button-next-date ${isDisabledNext ? 'disabled-button' : ''}`} onClick={handleNext} disabled={isDisabledNext}></button>
            </div>
        </div>
    );
}